    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div id="formPembelian">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input id="collybrg" type="text" class="form-control" placeholder="Colly">
                                            ...
                                            <button class="btn btn-outline-primary" id="savemasterdetail">
                                                Simpan
                                            </button>
                                            <button class="btn btn-outline-dark" id="cancelmasterdetail">
                                                Batal
                                            </button>
                                            <!----------------------->
                                            <!-- ---------------------------- -->
                ...
                <!-- Modal Tambah Barang-->
                <div class="modal fade" id="modalAddBarang" data-bs-backdrop="false" data-bs-keyboard="static" tabindex="-1" aria-labelledby="modalAddBarang" aria-hidden="true">
                                    ...
                                    <tbody id="tbodypilih">
                                        ...
                                        if (mysqli_num_rows($hasil) > 0) {
                                            while ($isi = mysqli_fetch_assoc($hasil)) {
                                                ...
                                                echo '<button id=' . $idkodebr . ' class="tambahpilih btn btn-primary" data-bs-dismiss="modal">✓</button>';
                                                echo '</td></tr>';
                                            }
                                        }
                                        ?>
                ...
                <div class="modal fade" id="ModalUpdateBarang" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div id="formBarang">
                                    <form action="tugas1tabelbarang.html" target="_blank" method="post" autocomplete="on">
                                        ...
                                        <label for="harga" class="form-label">Harga:</label>
                                        <input type="text" id="hargabrg" class="form-control"><br>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-dark" data-bs-dismiss="modal">Batal</button>
                                <button class="btnHapusBarang btn btn-danger" data-bs-toggle="modal" data-bs-target="#ModalHapusBarang" data-kode="M001">Hapus</button>
                                <button type="button" class="btn btn-primary" data-bs-dismiss="modal" name="update" id="update">Ubah</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <script>
                    ...
                    $(document).ready(function() {
                        $('#cancelmasterdetail').click(function() {
                            $('#this-page').load("transaksi/tabelbeli.php");
                        });
                    });
                    ...
                    $(document).ready(function() {
                        ...
                        $("#save").click(function() {
                            ...
                            let colly = $("#collybrg").val();
                            let jumlah = $("#jmlbrg").val();
                            let total = Number(+colly) * Number(+jumlah) * Number(+harga);
                            // console.log(total);
                            ...
                            $("#tbody").append(
                                ...
                                panjang +
                                '" class="remove btn btn-danger">x</button></tr>'
                            );
                            // console.log(panjang);
                        ...
                        $("#tbodypilih").on("click", ".tambahpilih", function() {
                            ...
                            $('#hargabrg').val(currentRow.find("td:eq(2)").text());
                            $('#collybrg').val(1);
                            $("#jmlbrg").val(1);
                        ...
                        $("#savemasterdetail").click(function() {
                            ...
                            let kodebeli1 = <?php echo date('YmdHis');  ?>;
                            ...
                            $("#tbody tr").each(function() {
                                ...
                                let harga1 = currentRow.find("td:eq(2)").text();
                                let colly1 = currentRow.find("td:eq(3)").text();
                                ...
                                $.post("transaksi/simpandetailbeli.php", {
                                    kodeBeli: kodebeli1,
                                    kodeBrg: kodebrg1,
                                    harga: harga1,
                                    colly: colly1,
                            ...
                            $.post("transaksi/simpanmasterbeli.php", {
                                kodeBeli: kodebeli1,
                                tanggal: tanggal1,
                                kodeKry: karyawan1,
                                konsumen: konsumen1,
