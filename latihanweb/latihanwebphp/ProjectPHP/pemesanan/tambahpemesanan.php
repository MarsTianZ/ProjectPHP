    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div class="shadow mb-4">
                        <div class="card-header py-3">
                            <div class="row p-3 flex right-content-between">
                                <h6 style="font-size: 30px;" class="m-0 font-weight-bold text-primary">Tambah Pemesanan</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div id="formPembelian">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <?php
                                                include 'C:\xampp\htdocs\webdasar\latihanweb\latihanwebphp\ProjectPHP\koneksi\koneksi.php';
                                                $sql = "select nmSupp from supp_table";
                                                $hasil =  mysqli_query($conn, $sql);
                                                ?>
                                        ...
                                        <button class="btn btn-success" id="savemasterdetail">
                                            Save
                                        </button>
                                        <button class="btn btn-outline-danger" id="cancelmasterdetail">
                                            Cancel
                                        </button>
                                        <!----------------------->
                                        <!-- ---------------------------- -->
                                ...
                                <tbody id="tbodypilih">
                                    ...
                                    if (mysqli_num_rows($hasil) > 0) {
                                        while ($isi = mysqli_fetch_assoc($hasil)) {
                                            ...
                                            echo '<button id=' . $kodebrg . ' class="tambahpilih btn btn-success" data-bs-dismiss="modal">✓</button>';
                                            echo '</td></tr>';
                                        }
                                    }
                                    ?>
            ...
            <script>
                // ------------------------- JS ADD ------------------------------------------------------
                // load cancel
                console.log("BALIK KE TABLE PEMESANAN");
                ...
                $(document).ready(function() {
                    ...
                    $("#savemasterdetail").click(function() {
                        ...
                        let kodepem1 = <?php echo date('YmdHis');  ?>;
                        ...
                        $("#tbody tr").each(function() {
                            ...
                            $.post("pemesanan/simpandetailpemesanan.php", {
                                kodepem: kodepem1,
                                kdBrg: kodebrg1,
                                hrgJual: hargajual1,
                                jumlah: jumlah1
                        ...
                        $.post("pemesanan/simpanmasterpemesanan.php", {
                            kodepem: kodepem1,
                            tanggal: tanggal1,
                            sup: supplier1,
                            kry: karyawan1,
